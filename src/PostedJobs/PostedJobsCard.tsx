...
return(
    <div className="p-2 bg-mine-shaft-800 flex  flex-col  rounded-xl border-l-2 border-l-bright-sun-400  transform duration-300 ease-in-out hover:translate-x-2">
