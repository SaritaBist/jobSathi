...
const Testimonials = () => {
    return (
        <div className="mt-20 px-4">
            <div className="text-3xl md:text-5xl text-mine-shaft-100 text-center intersect:motion-preset-expand">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-8 mx-4 md:mx-10 ">
                {testimonials.map((item) => (
                    <div
                        key={item.name}
                        className="flex flex-col gap-3 border border-bright-sun-400 rounded-lg p-4 intersect:motion-preset-shrink  motion-duration-2000"
                    >
