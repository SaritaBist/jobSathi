...
const JobCategoryPage=()=>{
    return(<>
        <div className="w-full mt-10 ">
            ...
            <div className=" text-lg  mb-5 text-center w-[35%] mx-auto text-mine-shaft-300">Explore diverse job opportunities tailored to your skills.Start your career journey today!</div>
