...
const JobCategoryPage=()=>{
    ...
    return(<>
        <div className="w-full my-10  px-12  xs-mx:px-5">
            <div className=" text-3xl md:text-4xl  font-semibold text-center text-mine-shaft-200 mb-2 intersect:motion-preset-expand ">Browse <span
                className="text-bright-sun-400">Job </span>Category
            </div>
            <div className=" text-lg  mb-5 text-center  mx-auto text-mine-shaft-300 intersect:motion-preset-expand ">Explore diverse job opportunities tailored to your skills.Start your career journey today!</div>
                ...
                >{
                    JobCategories.map((jobCategory,index)=><Carousel.Slide>
                            <div key={index} className='  border   border-bright-sun-400 py-3 rounded-xl  w-full flex flex-col  items-center mt-5 mb-2 hover:cursor-pointer  hover:shadow-[0_0_5px_2px_black] !shadow-bright-sun-300 transaction  duration-300 ease-in-out intersect:motion-preset-expand motion-duration-2000'>
                                <div>
                                    {jobCategory?.icon}
                                </div>
